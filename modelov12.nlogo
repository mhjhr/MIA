...
;;;;;;;;;;;;;;;;;;;;;;; ANTES DE LLEGAR A LA ZONA DE DESCARGA, SI HAY N CAMIONES DESCARGANDO REPOSA EN LA ZONA DESCARGA POS X 22, Y 0 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      if [pxcor] of patch-ahead 1 = 23 and [pycor] of patch-ahead 1 = 0 and heading = 90 and count turtles with [downloading = 1 and pxcor = 23 and pycor = 0 and flota = 1] >= max_camiones_desc_zn and reposo? = false
      [ set color black set speed 0 set reposo? true  set tail_downloading_zn lput who tail_downloading_zn set xcor 22 set ycor 0 ]

      if [pxcor] of patch-ahead 1 = 23 and [pycor] of patch-ahead 1 = 0 and heading = 90 and count turtles with [downloading = 1 and pxcor = 23 and pycor = 0 and flota = 1] < max_camiones_desc_zn and reposo? = false
      [ set xcor 23 set ycor 0 set speed 0]
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ANTES DE LLEGAR A LA ZONA DE DESCARGA, SI HAY N CAMIONES DESCARGANDO REPOSA EN LA ZONA DESCARGA SUR POS X 30, Y -36 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      if [pxcor] of patch-ahead 1 = 31 and [pycor] of patch-ahead 1 = -36 and heading = 90 and count turtles with [downloading = 1 and pxcor = 31 and pycor = -36 and flota = 2] >= max_camiones_desc_zs and reposo? = false
      [ set color black set speed 0 set reposo? true  set tail_downloading_zs lput who tail_downloading_zs set xcor 30 set ycor -36]

      if [pxcor] of patch-ahead 1 = 31 and [pycor] of patch-ahead 1 = -36 and heading = 90 and count turtles with [downloading = 1 and pxcor = 31 and pycor = -36 and flota = 2] < max_camiones_desc_zs and reposo? = false
      [  set xcor 31 set ycor -36 set speed 0]
...
to next_turn_downloading_zn [ntruck]
...
to next_turn_downloading_zs [ntruck]

   ask turtles with [who = ntruck]
    [
       set speed mi_velocidad_inicial
       set reposo? false
       set tail_downloading_zs remove-item 0 tail_downloading_zs
   ]
end
